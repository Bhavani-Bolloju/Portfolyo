...
const TestimonialItem = function ({ review, name, position, imageURL }) {
  return (
    <SplideSlide>
      <div className={classes["testimonial__item"]}>
        <Rating />
        <div className={classes["testimonial__item--text"]}>
          <p>{review}</p>
        </div>
        <div className={classes["testimonial__item--details"]}>
          <h3 className={classes["testimonial__item--author"]}>
            <span>{name}</span>
          </h3>
          <h3 className={classes["testimonial__item--job"]}>
            <span>{position}</span>
          </h3>
        </div>
        <div className={classes["testimonial__item--avatar"]}>
          <div
            className={classes["testimonial__item--image"]}
        ...
        <svg
          ...
          y="0px"
          viewBox="0 0 32 32"
          className={classes["testimonial__item--svg-quote"]}
          xmlSpace="preserve"
        >
          <g>
  ...
  /* <SplideSlide>
                ...
                <SplideSlide>
                  <div className={classes["testimonial__item"]}>
                    ...
                    <div className={classes["testimonial__item--text"]}>
                      <p>
                        The quality of the design is very high, and with a bit
                        of knowledge about HTML and CSS also very easy to
                        customize. Overall a good design, that I am quite happy
                        with. Really appreciate that.
                      </p>
                    </div>
                    <div className={classes["testimonial__item--details"]}>
                      <h3 className={classes["testimonial__item--author"]}>
