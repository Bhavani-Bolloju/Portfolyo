          ...
          <div className={classes["testimonial__list"]}>
            <div className={classes["testimonial__wrapper"]}>
              ...
              <div className={classes["testimonial__item"]}>
                ...
                <div className={classes["testimonial__item--text"]}>
                  <p>
                    The quality of the design is very high, and with a bit of
                    knowledge about HTML and CSS also very easy to customize.
                    Overall a good design, that I am quite happy with. Really
                    appreciate that.
                  </p>
                </div>
                <div className={classes["testimonial__item--details"]}>
              ...
              <div className={classes["testimonial__item"]}>
                ...
                <div className={classes["testimonial__item--text"]}>
                  <p>
                    ...
                    support! very happy with the website I bought. Thank you
                    developers!!
                  </p>
                </div>
                <div className={classes["testimonial__item--details"]}>
